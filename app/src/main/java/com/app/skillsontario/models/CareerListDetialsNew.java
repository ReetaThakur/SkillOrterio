...
public class CareerListDetialsNew implements Serializable {
    ...
    @Expose
    private List<Object> resourceURL = null;

    public List<Object> getResourceURL() {
        return resourceURL;
    }

    public void setResourceURL(List<Object> resourceURL) {
