...
public class PartnersPlatinumAdapter extends RecyclerView.Adapter<PartnersPlatinumAdapter.ViewHolder> {

    private ArrayList<String> listingDetails;
    private Context context;

    public PartnersPlatinumAdapter(Context context, List<String> listingDetails) {
