package dev.amin.tagadapter.check2
...
import dev.amin.tagadapter.Chack.MeasureHelper1
...
class TagAdapter2(
        ...
        context: Context
) : RecyclerView.Adapter<TagAdapter2.Holder>() {
     ...
     */
    private val measureHelper = MeasureHelper2(this, tagList.size)
